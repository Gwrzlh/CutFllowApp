            ...
            <main class="p-8">
                ...
                @if (session('error'))
                    <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 4000)" x-show="show" 
                        ...
                        x-transition:leave-start="opacity-100"
                        x-transition:leave-end="opacity-0"
                        class="fixed bottom-10 right-10 z-[100] max-w-sm w-full bg-white rounded-2xl shadow-2xl border-l-[6px] border-[#EF4444] p-5 flex items-center gap-4">
                        <div class="flex-shrink-0 w-10 h-10 bg-[#EF4444]/10 rounded-xl flex items-center justify-center">
                            <svg class="h-6 w-6 text-[#EF4444]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                            </svg>
                        </div>
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-bold text-[#0B224E] uppercase tracking-wider">Error</p>
