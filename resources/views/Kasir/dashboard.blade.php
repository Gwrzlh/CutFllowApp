...
<head>
    ...
    <title>Kasir Dashboard - Cutflow</title>
    ...
    <style>
        ...
        .badge { background: #10AC84; color: white; padding: 4px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; text-transform: uppercase; }
    </style>
</head>
<body>
    <div class="header">
        <div>
            <h2 style="margin:0">Kasir Dashboard</h2>
            <p style="margin:5px 0 0; color:#636E72">Selamat datang kembali, <strong>{{ Auth::user()->name }}</strong> <span class="badge">KASIR</span></p>
        </div>
    ...
    <div class="content">
        <h1>Overview Transactions</h1>
        <p>Silakan gunakan menu navigasi untuk mengelola transaksi.</p>
    </div>
</body>
</html>
