    ...
    <div class="fixed inset-y-0 right-0 pl-10 max-w-full flex">
        <div class="w-screen max-w-md shadow-2xl transition-all">
            <div class="h-full flex flex-col bg-white"
                ...
                <form action="{{ route('admin.users.store') }}" method="POST" class="h-full flex flex-col">
                    @csrf
                    <div class="flex-1 h-0 overflow-y-auto font-bold uppercase tracking-widest">
                        ...
                        <div class="px-8 py-6 bg-white border-b border-gray-100 flex items-center justify-between sticky top-0 z-10 font-bold uppercase tracking-widest border-b border-gray-100">
                            <h2 class="text-lg font-bold text-[#0B224E]">Form Add User</h2>
                        ...
                        <div class="px-8 py-10 space-y-8 font-normal">
                            ...
                            <div class="space-y-2 uppercase tracking-[0.2em]">
                                ...
                                <input type="text" name="name" id="name" placeholder="Tulis Nama Lengkap" value="{{ old('name') }}"
                            ...
                            <div class="space-y-2 uppercase tracking-[0.2em]">
                                ...
                                <input type="email" name="email" id="email" placeholder="Contoh: user@mail.com" value="{{ old('email') }}"
                            ...
                            <!-- Input Group -->
                            <div class="space-y-2 uppercase tracking-[0.2em]">
                                <label for="password" class="block text-[11px] font-bold text-gray-400">Password</label>
