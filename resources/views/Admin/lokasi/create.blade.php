...
<div class="fixed inset-0 z-50 overflow-hidden" x-data="{ open: true }" x-show="open" x-cloak>
    ...
    <div class="fixed inset-y-0 right-0 pl-10 max-w-full flex">
        <div class="w-screen max-w-md"
            ...
            <form action="{{ route('admin.lokasi.store') }}" method="POST" class="h-full flex flex-col bg-white shadow-2xl border-l border-gray-100 uppercase tracking-tight">
                @csrf
                <div class="flex-1 h-0 overflow-y-auto">
                    <!-- Drawer Header -->
                    <div class="px-8 py-6 bg-white border-b border-gray-50 flex items-center justify-between sticky top-0 z-10">
                        <h2 class="text-lg font-bold text-[#0B224E]">Form Add Lokasi</h2>
                    ...
                    <div class="px-8 py-10 space-y-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" id="name" placeholder="Tulis Nama Lokasi" value="{{ old('name') }}"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="Kabupaten" id="Kabupaten" placeholder="Tulis Nama Kabupaten" value="{{ old('Kabupaten') }}"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#1A337E]/20 focus:border-[#1A337E] transition-all" required>
